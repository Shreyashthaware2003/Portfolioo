          ...
          {showModal && (
            <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-md p-4">
              <div className="flex relative flex-col sm:flex-row sm:flex-nowrap gap-4 w-full md:max-w-3xl p-6">
                {/* Main Modal Box */}
                <div
                  className={`w-full sm:w-[90%]  rounded-xl border shadow-lg p-4 sm:p-6 relative overflow-y-auto max-h-[90vh] ${
                    darkMode
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                    ...
                    <div className="space-y-6 hidden md:inline">
                      <h3
                        className={`text-xl font-semibold ${darkMode ? "text-black" : "text-white"}`}
                      >
                        Get In Touch
                      </h3>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center ${darkMode ? "bg-gray-200 text-black" : "bg-[#27272a] text-white"}`}
                          >
                            <FiMail />
                          </div>
                          <div>
                            <p
                              className={`text-sm ${darkMode ? "text-black" : "text-white"}`}
                            >
                              Email
                            </p>
                            <a
                              className={`font-medium hover:underline ${darkMode ? "text-black" : "text-white"}`}
                              href="mailto:shreyashthaware284@gmail.com"
                            >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p
                              className={`font-medium ${darkMode ? "text-black" : "text-white"}`}
                            >
                              Nagpur, India
                            </p>
                          </div>
                    ...
                    >
                      ...
                      <form className="space-y-4" onSubmit={onSubmit}>
                        ...
                        <button
                          type="submit"
                          className={`w-full h-10 px-4 py-2 rounded-md font-medium text-sm transition-colors focus:outline-none focus:ring-2 cursor-pointer ${
                            darkMode
          ...
          >
            <div className="flex flex-col gap-4 max-w-lg">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  to={
                    "https://mail.google.com/mail/u/0/?fs=1&to=shreyashthaware284@gmail.com&tf=cm"
                  }
